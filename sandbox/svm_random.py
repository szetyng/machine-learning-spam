...
clf1 = SVC(C=1000, cache_size=1000, gamma=1e-05, kernel='rbf',max_iter=-1,random_state=0)
clf2 = SVC(C=1000, cache_size=1000, gamma=1e-05, kernel='rbf',max_iter=-1,random_state=1)
clf3 = SVC(C=1000, cache_size=1000, gamma=1e-05, kernel='rbf',max_iter=-1,random_state=2)
clf4 = SVC(C=1000, cache_size=1000, gamma=1e-05, kernel='rbf',max_iter=-1,random_state=None)
