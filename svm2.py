...
for cval in cvals:
	for gamma in gammas:
		models.append(('SVC with C: '+str(cval)+',gamma: '+str(gamma), SVC(C=cval,cache_size=1000,gamma=gamma,random_state=0,kernel='poly',degree=3)))
		i += 1
